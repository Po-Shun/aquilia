  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  printf ("Please give the number of 100,000 runs through the benchmark: ");
  {
    int n;
    scanf ("%d", &n);
    Number_Of_Runs = n * 100000; 10000000
  }
  printf ("\n");
#else
...
#endif
  volatile int var1 = CLOCKS_PER_SEC * Number_Of_Runs;
  
  // volatile int var1 = 456;
  asm volatile ("addi t1, %0, 0" : "=r"(var1));
  // volatile int var1 = 123;
  // asm volatile ("asdf adsgadf asdfa df ");
  volatile int var2 = User_Time;
  asm volatile ("addi t6, %0, 0" : "=r"(var2));
}
